...
"""
xss-utils documentation build configuration file.
...
project_title = 'XSS utilities for Django/Mako templates.'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Utilities to prevent possible XSS attacks on Django/Mako templates.',
     'Miscellaneous'),
]
